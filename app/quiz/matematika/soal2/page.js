...
export default function Soal2() {
  ...
  const handleJawab = (jawaban) => {
    localStorage.setItem("jawaban2", jawaban);
    router.push("/quiz/matematika/soal3");
  };

  return (
    <main className="min-h-screen bg-[#f9fafb] flex items-center justify-center px-4 py-10">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg text-center">
        <h2 className="text-base font-semibold text-blue-600 mb-2">Soal 2 dari 5</h2>
        <p className="text-xl font-bold text-gray-800 mb-6">5 - 3 = ?</p>
